...
const ImageList = [
    {
        ...
        description: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quam, totam animi. Ad et quidem autem ipsam vitae mollitia, ex distinctio!"
    },
    {
        id: 2,
        img: Image2,
            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
              ...
              <div className='order-1 sm:order-2'>
                <div data-aos='zoom-in' data-aos-once='true' className=' relative z-10'>
                  <img src={data.img} alt="" className='w-[300px] h-[300px] sm:h-[450px] sm:w-[450px] sm:scale-105 lg:scale-125 object-contain mx-auto' />
                </div>
              </div>
            </div>
          </div>
