        ...
        <div className='container flex justify-between items-center'>
            ...
            <div className='flex justify-between items-center gap-4'>
                <div className='relative group hidden sm:block'>
                    <input type="text" className='w-[200px] sm:w-[200px] group-hover:w-[300px] transition-all duration-300 rounded-full border border-gray-300 px-2 py-1 focus:outline-none focus:border-1 focus:border-primary dark:border-gray-500 dark:bg-gray-800' placeholder='Search' />
        ...
        <ul className='sm:flex hidden items-center gap-4'>
            ...
            <li className='group relative cursor-pointer'>
                <a href="#" className='flex items-center gap-[2px] py-2 hover:text-primary duration-200'>
                    ...
                    <div className='absolute z-50 hidden group-hover:block w-[150px] rounded-md bg-white p-2 text-black border border-t-2 border-primary shadow-md dark:bg-gray-900 dark:text-white'>
                        <ul>
